...
const nextConfig = {
  ...
  experimental: {
    ...
    serverComponentsExternalPackages: ['@anthropic-ai/sdk', 'puppeteer-core', '@sparticuz/chromium'],
  },
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "font-src 'self' data: https://*.stripecdn.com",
              "connect-src 'self' https://api.openai.com https://api.stripe.com https://*.stripe.com https://vercel.live wss://*.supabase.co https://*.supabase.co https://*.stripecdn.com",
              "frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://connect-js.stripe.com https://*.stripe.com https://www.google.com https://maps.google.com https://*.google.com https://www.openstreetmap.org",
              "object-src 'none'",
              "base-uri 'self'",
