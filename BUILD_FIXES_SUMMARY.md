# ✅ Build-Fehler analysiert und behoben!
...
4. **`scripts/delete-user.ts`**: `sellerId` existiert nicht im Purchase-Model
   - ✅ **Fix**: Purchases werden jetzt über `watchId` gelöscht (zuerst Watches des Users finden, dann Purchases löschen)
