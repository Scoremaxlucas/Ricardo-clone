      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-slate-700">
        ...
        <section>
          ...
          <p className="mt-1.5">
            ...
            möglich. Nach Ablauf werden die Nachweise nach einer Aufbewahrungsfrist von [AUFBEWAHRUNGSFRIST — vom
            Betreiber festzulegen] gelöscht; die QR-Prüfseite zeigt danach nur noch „abgelaufen".
          </p>
        </section>
