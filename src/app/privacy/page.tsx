      ...
      <main className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 md:p-12">
            ...
            <p className="text-gray-600 mb-8">Gültig seit 10. Juli 2025</p>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="space-y-8 text-gray-700">
                ...
                <section>
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">Bestätigung und Änderung dieser AGB</h4>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">1.2 Marktplatz von Helvenda</h3>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">1.3.2 Rechtsstellung von Helvenda</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">1.3.3 Kein Nutzungsanspruch</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">1.4.2 Angebot</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">1.4.3 Angebotsarten auf dem Marktplatz von Helvenda</h4>
                  <p className="mb-4">
                ...
                <section>
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">2.2 Beschreibung</h3>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">2.3.2 Persönliche Angaben</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">2.3.3 Personen mit Sitz im Ausland</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">2.4.2 Beendigung durch das Mitglied</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">2.4.3 Beendigung durch Helvenda</h4>
                  <p className="mb-4">
                ...
                <section>
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.2 Technische Eingriffe</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.3 Immaterialgüterrechte (Geistiges Eigentum)</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.4 Persönlichkeitsrechte Dritter</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.5 Keine Werbung</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.6 Links und Web-Adressen</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.7 Nutzung von Inhalten</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.8 Kein Vertragsschluss ausserhalb des Marktplatzes</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.9 Keine Manipulation von Auktionen durch Gebote</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.10 Wahrheitsgemässe Benutzung des Bewertungssystems</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">3.11 Verbot der Umgehung der Gebührenstruktur</h3>
                  <p className="mb-4">
                ...
                <section>
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">4.2 Veröffentlichte Inhalte, Angebote und Gebote; Kategorien</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">4.3 Wiederverwendung von veröffentlichten Inhalten</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">4.4 Verletzungen der AGB durch ein Mitglied</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">4.5 Änderungen der Angebotslaufzeit</h3>
                  <p className="mb-4">
                ...
                <section>
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">5.2 Kein Verkauf verbotener Artikel</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">5.3 Wahrheitsgemässe und vollständige Angaben über die Kaufsache</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">5.4 Kein Zwischenverkauf</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">5.5 Erfolgsprovision und Angebots-Boosts</h3>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">5.5.1 Reaktivierung von Angeboten</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">5.5.2 Zeitpunkt der Zahlungsaufforderung (früher Rechnungsstellung)</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">5.5.3 Zahlungsfrist</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">5.5.4 Zahlungsweise</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">5.6.2 Rückerstattung von Angebots-Boosts</h4>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">5.7 Mehrwertsteuer auf Umsätzen, die der Verkäufer auf Helvenda erzielt</h3>
                  <ul className="list-disc list-inside mb-4 ml-4 space-y-2">
                ...
                <section>
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">6.2.2 Form der Gebote</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">6.2.3 Verbindlichkeit des Gebots</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">6.2.4 Vertragsschluss</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">6.2.7 Rücktritt</h4>
                  <p className="mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">6.2.8 Produktemangel</h4>
                  <p className="mb-4">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">7 Mobile Endgeräte</h2>
                  <p className="mb-4">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">9 Übertragung von Rechten und Pflichten an Dritte</h2>
                  <p className="mb-4">
                ...
                <section>
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">10.2 Technische Störungen, Wartung</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">10.3 Inhalte und Angebote</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">10.4 Mitglieder und Dritte</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">10.5 Verlinkte Websites</h3>
                  <p className="mb-4">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">11 Freistellung</h2>
                  <p className="mb-4">
