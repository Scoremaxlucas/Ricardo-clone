export const de = {
  ...
  home: {
    ...
    superBoostOffers: '🏆 Gold Angebote',
    turboBoostFeatures: '🥈 Silber Angebote',
    premiumOffersDesc: 'Unsere Premium-Angebote mit maximaler Sichtbarkeit',
    highlightOffersDesc: 'Empfohlene Angebote mit erhöhter Sichtbarkeit',
    goldOffers: '🏆 Gold Angebote',
    silberOffers: '🥈 Silber Angebote',
    bronzeOffers: '🥉 Bronze Angebote',
  ...
  myWatches: {
    ...
    superBoostActive: 'Gold ist bereits aktiv!',
    superBoostActiveDesc: 'Ihr Angebot hat bereits den höchsten Booster-Level (Gold).',
    upgrade: 'Upgrade',
    price: 'Preis',
    save: 'Sie sparen',
    cancel: 'Abbrechen',
  ...
  helpArticles: {
    ...
    boosters: {
      ...
      content: [
        ...
        'Es gibt drei Booster-Stufen (wie bei Ricardo):',
        '',
        '🥉 Bronze (CHF 5.–):',
      ...
      tips: [
        'Gold-Booster sind besonders sinnvoll für wertvolle Artikel.',
  ...
  faqQuestions: {
    ...
    selling: [
      ...
      },
      {
        ...
        answer:
          'Booster machen Ihr Angebot sichtbarer. Es gibt drei Stufen: Bronze (fette Hervorhebung), Silber (+ Startseite) und Gold (garantiert ganz oben in allen Suchergebnissen).',
      },
      {
