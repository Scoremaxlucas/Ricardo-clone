...
export const enhancedSynonyms: Record<string, string[]> = {
  // ==================== SPORT & BALLSPORT ====================
  'ball': ['baelle', 'bälle', 'balls', 'fussball', 'fußball', 'soccer', 'football', 'basketball', 'volleyball', 'handball', 'tennis', 'tennisball', 'golfball', 'rugby', 'baseball', 'softball', 'medizinball', 'gymnastikball', 'spielball', 'sportball'],
  'fussball': ['fußball', 'soccer', 'football', 'ball', 'fussbaelle', 'fußbälle', 'fussballschuhe', 'trikot'],
  ...
  // ==================== FAHRRAD / VELO ====================
  'fahrrad': ['velo', 'bike', 'bicycle', 'rad', 'fahrräder', 'fahrraeder', 'bikes', 'zweirad', 'drahtesel'],
  ...
  'mountainbike': ['mtb', 'mountain bike', 'geländerad', 'mountainbikes', 'fullsuspension', 'hardtail', 'enduro', 'downhill', 'trail'],
  'ebike': ['e-bike', 'elektrofahrrad', 'elektrovelo', 'pedelec', 'ebikes', 'e-bikes', 'elektro', 'akku'],
  ...
  // ==================== COMPUTER & ELEKTRONIK ====================
  'laptop': ['notebook', 'computer', 'pc', 'laptops', 'notebooks', 'macbook', 'thinkpad', 'ultrabook', 'chromebook'],
  ...
  'rolex': ['luxusuhr', 'schweizer uhr', 'automatikuhr', 'submariner', 'datejust', 'daytona', 'gmt master', 'oyster'],
  ...
  'kaffeemaschine': ['coffee maker', 'espressomaschine', 'kaffeevollautomat', 'nespresso', 'jura', 'delonghi', 'siemens'],
...
export function expandQuery(query: string): {
  ...
  for (const token of tokens) {
    ...
    if (synonyms) {
      for (const syn of synonyms.slice(0, 10)) { // Limit synonyms per token
...
export function getCategorySuggestions(query: string): string[] {
  ...
  const categoryKeywords: Record<string, string[]> = {
    'elektronik': ['laptop', 'computer', 'handy', 'smartphone', 'tablet', 'kamera', 'tv', 'fernseher'],
