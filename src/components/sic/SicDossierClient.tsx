          ...
          <div className="mt-5">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-sic-hairline bg-sic-paper px-4 py-2.5 text-sm font-semibold text-sic-navy hover:bg-white"
              >
              ...
              <button
                ...
                disabled={recoding}
                className="inline-flex items-center gap-1.5 rounded-xl border border-sic-hairline px-3 py-2 text-xs font-semibold text-slate-600 hover:bg-white disabled:opacity-60"
              >
