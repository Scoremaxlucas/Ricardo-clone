...
import { PflanzenFields } from './Pflanzen'

export function GartenPflanzenFields({ subcategory, formData, onChange, disabled }: SubcategoryFieldsProps) {
  // Pflanzen
  if (subcategory === 'Pflanzen' || subcategory === 'Samen') {
    return <PflanzenFields formData={formData} onChange={onChange} disabled={disabled} />
  }
