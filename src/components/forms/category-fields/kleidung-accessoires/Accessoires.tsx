...
export function AccessoiresFields({ subcategory, formData, onChange, disabled = false }: SubcategoryFieldsProps) {
  const isGuertel = subcategory?.includes('Gürtel') || subcategory === 'Gürtel' || subcategory === 'Ledergürtel'
