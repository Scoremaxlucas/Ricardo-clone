...
/**
 * Konsolen-spezifische Felder (PS5, Xbox, Switch, etc.)
 * NICHT für Videospiele – dafür VideogameFields verwenden.
 */
export function KonsolenFields({ formData, onChange, disabled = false }: SubcategoryFieldsProps) {
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-semibold text-gray-900">Konsolen-Details</h3>
