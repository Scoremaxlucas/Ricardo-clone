...
export function TastaturenFields({ formData, onChange, disabled = false }: SubcategoryFieldsProps) {
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-semibold text-gray-900">Tastatur-Details</h3>
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          <input
            ...
            placeholder="z.B. MX Keys, K70 RGB"
            required
          />
        </div>
        <div>
