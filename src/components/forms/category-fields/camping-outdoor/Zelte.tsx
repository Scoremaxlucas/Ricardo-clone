...
export function ZelteFields({ formData, onChange, disabled = false }: SubcategoryFieldsProps) {
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-semibold text-gray-900">Zelt-Details</h3>
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div>
          ...
          <input
            ...
            placeholder="z.B. Coleman, Quechua, MSR"
            required
          />
        </div>
        <div>
          ...
          <input
            ...
            placeholder="z.B. Sundome 4, Arpenaz 3"
            required
          />
        </div>
        <div>
