  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          transform: currentVariant === 'wave' ? 'rotate(-5deg)' : currentVariant === 'happy' ? 'rotate(3deg)' : 'rotate(0deg)',
      ...
      >
        <Image
          ...
          onError={(e) => {
            ...
            console.warn('Kuh-Bild nicht gefunden. Bitte platziere helvenda-cow.png in /public/images/')
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-gray-100 rounded-full opacity-0 pointer-events-none" style={{ display: 'none' }}>
