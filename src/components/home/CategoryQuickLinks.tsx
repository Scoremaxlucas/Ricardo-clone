          ...
          {categories.map(category => {
            ...
            return (
              <Link
                key={category.slug}
                href={category.href}
                className="group flex min-w-[80px] flex-col items-center gap-2 rounded-xl p-3 transition-all duration-300 hover:bg-white/10 hover:scale-105 md:min-w-[100px]"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white/20 text-white transition-all duration-300 group-hover:bg-white/30 group-hover:scale-110 md:h-14 md:w-14">
