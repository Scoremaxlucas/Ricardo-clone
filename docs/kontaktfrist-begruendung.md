# Warum gibt es eine 7-Tage-Kontaktfrist?
...
### Für den Verkäufer (wenn er nicht innerhalb von 7 Tagen kontaktiert):

1. **Warnung & Erinnerung**
   - Automatische E-Mail-Benachrichtigung nach 5 Tagen
   - Plattform-Benachrichtigung mit Erinnerung
   - Hinweis auf mögliche Konsequenzen

2. **Nach 7 Tagen ohne Kontakt:**
   - **Automatische Stornierung möglich**: Käufer kann den Kauf stornieren
   - **Negative Bewertung möglich**: Käufer kann eine negative Bewertung abgeben
   - **Account-Warnung**: Verkäufer erhält eine Warnung auf seinem Account
   - **Mögliche Sperrung**: Bei wiederholten Verstößen kann der Account gesperrt werden

3. **Käufer-Schutz:**
   - Käufer erhält **vollständige Rückerstattung** (falls bereits gezahlt)
   - Käufer kann **Ersatzartikel** suchen
   - Käufer erhält **Entschädigung** für entstandene Unannehmlichkeiten

### Für den Käufer (wenn er nicht innerhalb von 7 Tagen zahlt):

1. **Warnung & Erinnerung**
   - Automatische E-Mail-Benachrichtigung nach 5 Tagen
   - Plattform-Benachrichtigung mit Zahlungserinnerung

2. **Nach 7 Tagen ohne Zahlung:**
   - **Automatische Stornierung**: Verkäufer kann den Kauf stornieren
   - **Negative Bewertung**: Verkäufer kann eine negative Bewertung abgeben
   - **Account-Warnung**: Käufer erhält eine Warnung
   - **Mögliche Sperrung**: Bei wiederholten Verstößen kann der Account gesperrt werden

3. **Verkäufer-Schutz:**
   - Verkäufer kann Artikel **erneut anbieten**
   - Verkäufer erhält **Entschädigung** für entstandene Kosten
   - Verkäufer kann **Ersatzgebühren** verlangen
